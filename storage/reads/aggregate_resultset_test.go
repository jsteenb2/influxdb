...
func TestNewWindowAggregateResultSet_Count(t *testing.T) {
	...
	if !reflect.DeepEqual(integerArray.Timestamps, []int64{1000000010, 1000000020, 1000000030, 2678400000000010, 5000000000000010, 5097600000000010}) {
		t.Log(time.Unix(0, integerArray.Timestamps[0]))
		t.Errorf("unexpected count timestamps: %v", integerArray.Timestamps)
	}
	if !reflect.DeepEqual(integerArray.Values, []int64{2, 5, 1, 1, 1, 1}) {
...
func TestNewWindowAggregateResultSet_Months(t *testing.T) {
	...
	if !reflect.DeepEqual(integerArray.Timestamps, []int64{2678400000000000, 5097600000000000, 7776000000000000}) {
		t.Log(time.Unix(0, integerArray.Timestamps[0]))
		t.Errorf("unexpected month timestamps: %v", integerArray.Timestamps)
	}
	if !reflect.DeepEqual(integerArray.Values, []int64{8, 2, 1}) {
		t.Errorf("unexpected month values: %v", integerArray.Values)
	}
}
